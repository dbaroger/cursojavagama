...
/*
 * Padrão DTO (TO ou Beans) Data Transfer Object
 * Todo atributo deve ser pivate
 * Todo atributo deve possuir um método GET (output) e SET (input)
 * Deve existir um construtor vazio e um outro para preencher o objeto no mínimo
 */
...
public class Produto {
	...
	// Metodo construtor.
	// Quando se instanciar o objeto Produto, esse metodo é chamado inicialmente.
